...
function Navbar() {
    ...
    return (
        <div className='fixed top-0 left-0 w-full z-50 bg-[#0F172A] text-white shadow-md shadow-gray-700'>
                ...
                <div className="container mx-auto flex justify-between items-center py-2 px-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <ul className={`flex flex-col md:flex-row gap-3 md:items-center absolute md:static w-full left-0 md:w-auto transition-all duration-300 ease-in-out ${isOpen ? 'top-14' : 'top-[-490px]'} bg-[#0F172A] border-b-4 md:border-b-0 border-themeColor pb-2 md:pb-0`}>
                            ...
                            <li>
                                <NavLink onClick={handleToggle} className='block py-2 px-4 hover:bg-themeColor text-center rounded-lg' to={'/blogs'}>
                                    Blogs
                                </NavLink>
                            </li>
                        </ul>
